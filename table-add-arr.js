...
// // Функция createRow создает строку <tr> на основе переданного объекта
// function createRow(obj) {
...
//     // Устанавливаем текстовое содержимое ячейки
...
// // Функция renderGoods принимает массив с объектами и вставляет строки в таблицу
// function renderGoods(arr) {
...
//   // Используем метод forEach для создания и добавления строк в таблицу
//   arr.forEach(obj => {
...
// // Пример использования функции renderGoods
// const goods = [
//   { name: 'Товар 10', price: 100 },
//   { name: 'Товар 20', price: 200 },
//   { name: 'Товар 30', price: 300 }
// ];

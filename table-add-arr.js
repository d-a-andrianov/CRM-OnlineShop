...
// 
{
  const createRow = ({ id, title, category, units, count, price, allPrice }) => {
    ...
    <td class='cms__table-tbody-icons'>
      ...
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="akar-icons:edit" clip-path="url(#clip0_3855_208)">
      <g id="Group">
      ...
      <defs>
      <clipPath id="clip0_3855_208">
      <rect width="20" height="20" fill="white"/>
      </clipPath>
      </defs>
      </svg></button>

      <button class='cms__table-tbody-button' aria-label="delete"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
